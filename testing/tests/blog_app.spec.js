...
describe('Blog app', () => {
  ...
  test('Main blog page is shown', async ({ page }) => {
  ...
  describe('Login', () => {
    test('succeeeds with correct credentials', async ({ page }) => {
        ...
        await expect(page.getByText('succesfully logged in as tristank')).toBeVisible()
    })
  ...
  describe('When logged in', () => {
    ...
    describe('Logged in with one blog in it', () => {
        ...
        test('a blog can be liked', async ({ page }) => {
            await page.getByRole('link', { name: 'cool blog' }).click()
